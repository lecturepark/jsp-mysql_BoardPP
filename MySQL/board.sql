...
insert into cat_board (num,title,content,id,adatetime,recommend)
values (0,'니능력을','입증해볼태냐','내가왜...',now()
...
update cat_board set recommend = recommend+1 where num=50;
...
drop table signin;
delete from signin where id = 'atata';
delete from cat_board where num = 55;
select * from asd; 
select * from cat_board; 
SELECT * FROM cat_board LIMIT 5 OFFSET 0;
select * from signin; 