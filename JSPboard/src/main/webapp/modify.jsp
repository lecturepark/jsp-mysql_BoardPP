...
<h4>글제목:<input type="text" style= width:300px; class="form-control" placeholder="글제목" name="title" maxlength="100"></h4><br>
<h4>글작성자id:<input type="text" style= width:300px; class="form-control" placeholder="작성자id" name="id" maxlength="100"></h4><br>
<h4>글내용:<textarea class="form-control" placeholder="내용을 입력하세요" name="content" maxlength="100" style=" height : 150px; width:98%;"></textarea></h4><br><br>
</div>
