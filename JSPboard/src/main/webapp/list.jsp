...
if(myid==null){
	myid = "geust";
	%><h3>🐺<%= myid %>로 입장시 게시글 확인만 가능합니다🐺</h3><%
}

%>

<%
if(myid.equals("admin123")){
	myid = "관리자";
	%><h3>👽<%= myid %>로 입장하셨습니다👽</h3><%
}
%>


<h2><%= myid %>님 안녕하세요</h2>
<a href="listhit.jsp?Page=1" style="color: red">힛갤</a><br>
...
%>
	...
	<a href="reportlist.jsp" style="color: red">신고 글 확인</a><br>
